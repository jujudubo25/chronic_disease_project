...
individuals <- read_csv("/Users/julia/chronic_disease_project/data/clean/diabetes_individual_clean.csv")
county_prevalence <- read_delim("/Users/julia/chronic_disease_project/data/raw/chronic_county.csv")
race_lookup <- read_csv("/Users/julia/chronic_disease_project/data/raw/diabetes_individual_with_race.csv")
...
set.seed(123)
individuals_clinic <- race_lookup %>%
  mutate(
    clinic_id = sample(
      x = c(1,2),
      size=n(),
